...
# Load the YOLO model
model = YOLO(r"C:\Python\miniCourse\best(2).pt")
...
left_frame.configure(height=600)  # 设置左侧框架的高度为600像素

right_frame = tk.Frame(root)
right_frame.pack(side="right", expand=True, fill="y")
right_frame.configure(height=600)  # 设置右侧框架的高度为600像素
...
confidence_threshold.set(0.6)  # 设置初始的置信度阈值
